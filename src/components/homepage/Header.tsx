			...
			<nav className="flex justify-between items-center max-w-[99.75rem] mx-auto ">
				...
				<div className="flex items-center space-x-4 md:space-x-6">
					...
					<IconButton
						...
						className="hidden sm:block p-2 rounded-full  cursor-pointer hover:rounded-full bg-gray-100 
						 hover:bg-gray-200 dark:hover:bg-gray-900 dark:bg-gray-800 transition"
					/>
					<IconButton
						badgeCount={7}
